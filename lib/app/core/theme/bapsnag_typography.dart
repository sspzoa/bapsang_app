...
class BapsangTypography extends ThemeExtension<BapsangTypography> {
  ...
  BapsangTypography({
    ...
    TextStyle? paragraph2Underlined,
        ...
        itemDescription =
            itemDescription ?? style(Weight.medium, 14, 20, defaultColor),
        description =
            description ?? style(Weight.semiBold, 16, 22, defaultColor),
        ...
        paragraph1 =
            paragraph1 ?? style(Weight.regular, 16, 16 * 1.6, defaultColor),
        paragraph2 =
            paragraph2 ?? style(Weight.regular, 14, 14 * 1.6, defaultColor),
        paragraph1Underlined = paragraph1Underlined ??
            style(Weight.regular, 16, 16 * 1.6, underlined: true, defaultColor),
        paragraph2Underlined = paragraph2Underlined ??
            style(Weight.regular, 14, 14 * 1.6, underlined: true, defaultColor);
  ...
  @override
  ThemeExtension<BapsangTypography> copyWith({
    Color? defaultColor,
    TextStyle? title,
    TextStyle? header1,
    TextStyle? header2,
  ...
  @override
  ThemeExtension<BapsangTypography> lerp(
      covariant ThemeExtension<BapsangTypography>? other, double t) {
    if (other is! BapsangTypography) {
      return this;
    }
    return BapsangTypography(
      ...
      paragraph1Underlined:
          TextStyle.lerp(paragraph1Underlined, other.paragraph1Underlined, t),
      paragraph2Underlined:
          TextStyle.lerp(paragraph2Underlined, other.paragraph2Underlined, t),
    );
  }
}
