...
class BapsangColors extends ThemeExtension<BapsangColors> {
  ...
  @override
  ThemeExtension<BapsangColors> copyWith({
    Color? grayscale100,
    Color? grayscale200,
    Color? grayscale300,
    Color? grayscale400,
  ...
  @override
  ThemeExtension<BapsangColors> lerp(
      covariant ThemeExtension<BapsangColors>? other, double t) {
    if (other is! BapsangColors) {
      return this;
    }
